...
find(Ans):-
        ...
        Familii=[A,B,C,D],
        naprotiv(kuznecov,S3,Familii), /*1. Напротив Кузнецова сидит слесарь.*/
        sprava(slesarev,S2,Familii), /*3. Справа от Слесарева сидит токарь.*/
        naprotiv(rezchikov,S4,Familii), /*2. Напротив Резчикова сидит резчик.*/
        sleva(Ans,S1,Familii). /*Кто сидит слева от кузнеца?*/
